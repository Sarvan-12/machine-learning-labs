...
| 03 | [`03_lab_3.ipynb`](03_lab_3.ipynb) | Pair Plots, Correlation Matrix, and Heatmaps. |
| 04 | [`04_lab_4.ipynb`](04_lab_4.ipynb) | Distribution of Sample Means (Central Limit Theorem demonstration). |
| 05 | [`05_lab_5.ipynb`](05_lab_5.ipynb) | One-Sample T-test for mean heart rate increase. |
| 06 | [`06_lab_6.ipynb`](06_lab_6.ipynb) | Two-Proportion Z-test for A/B testing conversion rates. |
| 07 | [`07_lab_7.ipynb`](07_lab_7.ipynb) | Independent Two-Sample T-test (Welch's T-test) for average sales. |
| 08 | [`08_lab_8.ipynb`](08_lab_8.ipynb) | Multiple Linear Regression with categorical variables. |
